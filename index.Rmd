...
I work as the Director of Equitable Analysis in [The Equity Center](https://virginiaequitycenter.org) at the University of Virginia working with an amazing collection of scholars and practitioners, community experts, and students to create analysis and tools in support of a more just and equitable region. And I teach in the [Batten School of Leadership in Public Policy](https://batten.virginia.edu/), focusing on data ethics, public interest technology, and equitable policy.

I have been fortunate to engage in a wide variety of work -- as a political science professor and quantitative scholar at the University of Oklahoma and the University of Virginia; as a data scientist engaged in applied work with the [Weldon Cooper Center for Public Service](https://demographics.coopercenter.org/); and as a consultant and leader creating [UVA's StatLab](https://data.library.virginia.edu/statlab/), as a library director building [Research Data Services and the Social, Natural, and Engineering Sciences](https://data.library.virginia.edu/), and as a researcher bridging applied and academic interests with community partners and advocates . 
